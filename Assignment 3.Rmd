...
plot(g,layout=layout.fruchterman.reingold, vertex.color=VERTEX$major, edge.width=EDGE$count/10)
...
plot(g, layout = layout.fruchterman.reingold, vertex.size = 4, vertex.label.cex = 0.8, vertex.label.color = "black", vertex.color = "red")
